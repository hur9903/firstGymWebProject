...
<footer >
    <div class="footer-container">
        ...
        <div class="footer-menu">
            <ul>
                <li>고객센터</li><br>
                <li><img src="${pageContext.request.contextPath }/resources/image/mail.png" alt="" class="footer-mail"> E-MAIL: firstgym@naver.com</li>
                <li><button class="footer-manager"><a href="#">관리자에게</a></button></li>
            </ul>
